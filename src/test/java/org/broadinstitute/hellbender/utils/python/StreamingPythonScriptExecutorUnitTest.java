...
public class StreamingPythonScriptExecutorUnitTest extends GATKBaseTest {
    ...
    public void testAsyncWriteService(final PythonScriptExecutor.PythonExecutableName executableName) throws IOException {
        ...
        final AsynchronousStreamWriterService<String>asyncWriter =
                streamingPythonExecutor.initStreamWriter(AsynchronousStreamWriterService.stringSerializer);
    ...
    public void testPythonAssert(final PythonScriptExecutor.PythonExecutableName executableName) {
        ...
        try {
            streamingPythonExecutor.sendSynchronousCommand("assert false" + NL);
        }
        finally {
            streamingPythonExecutor.terminate();
            Assert.assertFalse(streamingPythonExecutor.getProcess().isAlive());
