...
// Tests for the StreamingProcessController. Although these tests use and are dependent on Python, they do not test
...
public class StreamingProcessControllerUnitTest extends BaseTest {
    ...
    @Test(timeOut = 50000)
    public void testMultipleParallelStreamingControllers() throws TimeoutException, IOException {
