 ...
 * that is created by the executor. A second FIFO can  be used to pass data from GATK to the Python process in batches.
 * The lifecycle of an executor is typically:
 *
